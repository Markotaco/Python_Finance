...
# The intended purpose for this file is to take in a dictionary of stocks and the amount invested in each stocks and to generate a Sharpe Ratio of the portfolio. 
# It is meant to be an easy tool for those looking to evaluate their stock portfolios. 
# Due to the simplicity of the tool, this is also **NOT** meant for day traders, but instead people who are taking a more long-term perspective to investing.

# -------------------------------------------------------------------------------------------------------------------------------------------------------------------

# ## Input Fields
# Please fill in the stock tickers and the associated amount invested into the following fields. 
# Ensure that the values are in the same currency. Please also fill in the annual risk-free rate you would like it to be evaluated at.
...
# Lastly, please fill in the type of returns you would like to see. 
